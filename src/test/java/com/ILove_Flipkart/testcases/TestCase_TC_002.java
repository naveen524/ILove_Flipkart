package com.ILove_Flipkart.testcases;
...
import com.ILove_Flipkart.pageobjectmodel.Add_To_Cart;
import com.ILove_Flipkart.pageobjectmodel.Login;
...
public class TestCase_TC_002 extends BaseClass {
	...
	public void tearDown(ITestResult result)
	{
		if(ITestResult.FAILURE==result.getStatus())
		{
			...
			com.ILove_Flipkart.utilities.Utility.takes_Screenshot(driver, result.getName());
		}
		driver.close();
	}
}
